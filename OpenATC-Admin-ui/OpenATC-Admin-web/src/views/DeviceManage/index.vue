...
<template>
  <div>
    <Messagebox :visible="messageboxVisible" text="是否删除此设备?" @cancle="cancle" @ok="ok"/>
    ...
    <div class="devs-table">
      <el-table
          ...
          <template slot-scope="scope">
              ...
              <el-button type="text" @click="handleToDetail(scope.$index)">详情</el-button>
