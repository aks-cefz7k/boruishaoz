...
-- ----------------------------
DROP TABLE IF EXISTS "public"."t_orgnization";
CREATE TABLE "public"."t_orgnization" (
  "id" int4 NOT NULL,
...
-- ----------------------------
ALTER TABLE "public"."t_orgnization" ADD CONSTRAINT "t_orgnization_pkey" PRIMARY KEY ("id");
