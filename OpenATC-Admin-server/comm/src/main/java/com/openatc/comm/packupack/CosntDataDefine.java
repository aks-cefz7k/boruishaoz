...
//////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  //infotype 和operation相关字符串定义
    ...
    public static final String volume = "status/currentvolume";//2交通流,当前流量
    public static final String workstatus = "status/pattern";//3    工作状态（对应私有，首页查询）
    public static final String lampcolor = "status/channel";//4
    public static final String time = "system/time";//当前时间5
    public static final String signalgroup = "feature/channel";//6信号灯组
    public static final String phase = "feature/phase";//7
    public static final String timepattern = "feature/pattern";//配时方案8
    public static final String scheduleplan = "feature/plan";//9方案调度计划
    public static final String workmode = "control/pattern";//10
    public static final String falut = "status/fault";//11信号机故障
    public static final String atcversion = "system/version";//12信号机版本
    public static final String paramversion = "system/paramversion";//13
    public static final String code = "system/code";//14识别码
    public static final String remote = "control/remote";//15远程控制
    public static final String detector = "feature/detecter";//16

    public static final String allfeature = "feature/all";           //17自定义   0xA0整体参数
    public static final String paramip = "system/ip";//自定义  IP
    public static final String serialport = "system/serialport";//串口 自定义
